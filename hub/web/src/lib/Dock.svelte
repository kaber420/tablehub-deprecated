<script>
  import { LayoutDashboard, Users, Settings, Palette, Tablet, Server, LogOut, ChevronUp, ChevronDown } from '@lucide/svelte';
    ...
    <div class="profile-menu-container">
      ...
      >
        <div class="profile-avatar">
          <svelte:component this={Server} size={18} strokeWidth={1.5} />
        </div>
        <div class="profile-info">
          <span class="username">Admin</span>
          <span class="role">Local Hub</span>
        </div>
      ...
      {#if menuOpen}
        <div class="profile-dropdown pos-{position}">
          <div class="dropdown-header">
            ...
            <span class="dropdown-role">Control Local</span>
          </div>
...
<style>
  ...
  .pos-left .profile-info, .pos-right .profile-info {
    display: none; /* Hide text in vertical dock positions to save space, or style as needed */
  }
